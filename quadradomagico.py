...
Professora eu acabei não conseguindo fazer a animação funcione de forma correta
então eu coloquei um input() para poder pausar a animação em quanto ela é
exibida na tela para que o usuário possa ler. Então para que o programa funcione
é preciso que o usuário aperte ENTER no console quando a mensagem for exibida e
voltar para a janela do turtle. O usuário precisa apertar ENTER 2 vezes para que o
programa funcione
